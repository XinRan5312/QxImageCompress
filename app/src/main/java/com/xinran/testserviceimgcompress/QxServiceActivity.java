package com.xinran.testserviceimgcompress;
...
import com.xinran.testserviceimgcompress.utils.CompressServiceParam;
import com.xinran.testserviceimgcompress.utils.QxIntentService;
import com.xinran.testserviceimgcompress.utils.QxMultiThreadService;
import com.xinran.testserviceimgcompress.utils.QxPhoneImgCompress;
 ...
 */
public class QxServiceActivity extends AppCompatActivity {
    private final String TAG = QxServiceActivity.class.getSimpleName();
    ...
    private class CompressingReciver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (flag == Constanse.FLAG_END) {
                ArrayList<QxPhoneImgCompress.CompressResult> compressResults =
                        (ArrayList<QxPhoneImgCompress.CompressResult>) intent.getSerializableExtra(Constanse.KEY_COMPRESS_RESULT);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.intent_service).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                for (int i = 0; i < compressFiles.size(); ++i) {
                    ...
                    QxIntentService.startActionCompress(QxServiceActivity.this, param);
                }
            }
        });
        ...
        findViewById(R.id.service).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Log.d(TAG, compressFiles.size() + "compresse begain");
                Intent intent = new Intent(QxServiceActivity.this, QxMultiThreadService.class);
